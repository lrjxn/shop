...
function my_theme_scripts() {
	...
	wp_enqueue_script( 'my-theme-script', get_template_directory_uri() . '/js/script.js', array('jquery'));
 ...
 */
 ...
 function enqueue_custom_fonts() {
	if(!is_admin()) {
		wp_register_style('source_sans_serif', "https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap");

		wp_enqueue_style('source_sans_serif');
	}
 }
...
add_filter('woocommerce_enqueue_style', 'remove_woocommerce_styles'); 
